...
Source URL: https://apsimnextgeneration.netlify.app/usage/report
Source domain: apsimnextgeneration.netlify.app
Fetched at: 2026-04-19T09:51:29.167482+00:00
...
Double-clicking a variable from the list on the right.
Dragging a variable from the common report variables list to the report variables window.
Typing the code directly into the reporting variables window.
...
Use the ‘submit new event/variable’ button in the common report events window.
...
https://github.com/APSIMInitiative/ApsimX/issues/new?assignees=&labels=New+common+report+event%2Fvariable&projects=&template=new-common-report-event-variable.yml
