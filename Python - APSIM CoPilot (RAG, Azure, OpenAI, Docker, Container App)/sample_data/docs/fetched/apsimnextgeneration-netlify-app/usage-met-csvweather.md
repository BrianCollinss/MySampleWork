...
Source URL: https://apsimnextgeneration.netlify.app/usage/met/csvweather
Source domain: apsimnextgeneration.netlify.app
Fetched at: 2026-04-19T09:51:23.203749+00:00
...
Note that the constants file
must
contain a latitude.
Format of the .csv file
The .csv file must be
RFC 4180
-compliant. The first row of the .csv file must contain the column names, and there is currently no support for specifying units. Expected units are:
°C for temperatures
MJ/m2 for radiation
mm for rain
hPa for pressure
