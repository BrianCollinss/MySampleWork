...
Source URL: https://apsimnextgeneration.netlify.app/contribute
Source domain: apsimnextgeneration.netlify.app
Fetched at: 2026-04-19T09:51:31.211982+00:00
...
if issue might be of interest to the Reference Panel.
Step 3 Developer raises a GitHub Pull Request (PR)
Ensure the PR conforms to the
PR guidelines
The developer must link to an issue. Use
working on #issue
or
resolves #issue
...
When development is complete, the developer adds a
Ready for Review
label.
