...
| [Fabric - NEMWeb Energy Market Data Pipeline (Lakehouse, PySpark, Delta, Power BI, Direct Lake)](./Fabric%20-%20NEMWeb%20Energy%20Market%20Data%20Pipeline%20(Lakehouse,%20PySpark,%20Delta,%20Power%20BI,%20Direct%20Lake)) | Microsoft Fabric, Lakehouse, Energy Market Analytics | Microsoft Fabric, PySpark, Delta Lake, Power BI, Direct Lake | Fabric Lakehouse pipeline that ingests public AEMO NEMWeb ZIP files, parses MMSDM-style CSV records, builds Bronze/Silver/Gold Delta tables, and prepares Power BI-ready reporting outputs for NEM price, demand, generation, interconnector, and data-operations analysis. |
...
| [PowerBI - Maize Performance under Climate Change in Iran (Modelling, Reporting)](./PowerBI%20-%20Maize%20Performance%20under%20Climate%20Change%20in%20Iran%20(Modelling,%20Reporting)) | Power BI, Crop Modelling, Climate Analytics | Power BI, APSIM, parquet, climate scenarios, GCMs, SSPs | Power BI dashboard reporting APSIM maize simulations across cultivars, sowing dates, irrigation regimes, nitrogen fertilisation rates, historical climate, and future SSP/GCM scenarios. |
...
- `LICENSE` or `LICENCE` containing the repository's proprietary usage notice
