...
| [Peer-Review](./Peer-Review) | Research Communication | Gallery of selected figures from peer-reviewed publications and posters. |
| [PowerBI - Sample 1](./PowerBI%20-%20Sample%201) | Power BI, Data Modelling | Power BI sample built on a synthetic e-commerce star schema with dimension and fact tables generated in R. |
