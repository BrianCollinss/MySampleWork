...
| [R - Student Data Analysis](./R%20and%20Python%20-%20Test) | Student Analytics, Exploratory Analysis | R, readxl, dplyr, ggplot2, rmarkdown, renv | Compact R analysis project that explores de-identified student data, profiles study-area patterns across subgroups, reviews missingness and correlations, and builds a simple retention analysis notebook with exported tables and figures. |
